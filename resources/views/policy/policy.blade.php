...
@section('content')
    <div class="container">
        <div class="row">
            @include('sidemenu')
            <div class="col col-xl-9 no-padding-margin mt-3">
                <div class="content-title">
                    プライバシーポリシー
                </div>
                <div class="mx-3 my-5">
                    <p>当アプリケーションは、利用者のプライバシー保護を重視し、利用者情報の取り扱いには細心の注意を払っています。以下のプライバシーポリシーは、当アプリケーションで取り扱う個人情報について、どのように収集・利用・管理されるかについて示したものです。
                    </p>
                    <p>1. 収集する情報の範囲</p>
                    ...
                    <p>3. 個人情報の管理</p>
                    <p>当アプリケーションは、利用者の個人情報を適切に管理し、紛失・漏洩・改ざんなどの防止に努めます。また、個人情報を外部に委託する場合がある場合は、個人情報保護法に基づき、委託先に対し適切な契約を締結し、管理を徹底します。
                    </p>
                    ...
                    <p>当アプリケーションでは、利用者の利便性向上のため、Cookieを使用しています。Cookieは、利用者のブラウザに保存され、Webサイトの閲覧時に利用されます。なお、Cookieの使用によって、利用者の個人情報が収集されることはありません。また、利用者は、ブラウザの設定によりCookieの受け取りを拒否することができますが、その場合、当アプリケーションの一部の機能が制限される場合があります。
                        当アプリケーションでは、Google Analyticsを利用して、利用者の利便性向上のための情報を収集しています。Google
                        Analyticsは、Cookieを利用して、利用者の情報を収集しています。収集された情報は、当アプリケーションの利便性向上以外の目的には使用されません。また、Google
                        Analyticsの利用によって、利用者の個人情報が収集されることはありません。なお、Google Analyticsの利用については、Googleのプライバシーポリシーをご確認ください。</p>
                </div>
            </div>
        </div>
    </div>
